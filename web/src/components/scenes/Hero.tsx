...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="deco-500 block rotate-[-6deg] text-[58vw] tracking-[-0.06em] will-change-transform">500</span>
      </div>

      {/* Eyebrow top-left */}
      <div className="absolute left-8 top-8 md:left-16 md:top-12 xl:left-24">
      ...
      <div className="relative mx-auto grid min-h-[100dvh] max-w-none grid-cols-12 items-center gap-x-6 px-8 pb-24 pt-32 md:gap-x-8 md:px-16 md:pb-32 md:pt-40 xl:px-24">
        ...
        <div className="col-span-12 mt-16 md:mt-20">
          <div className="grid grid-cols-1 gap-y-8 border-t border-hairline pt-8 sm:grid-cols-3 sm:justify-items-stretch sm:gap-x-16">
            {/* Block 1 — left edge */}
            <div>
        ...
        {/* CTA row */}
        <div className="col-span-12 mt-16 flex flex-col items-start gap-6 md:mt-20 md:flex-row md:items-center md:gap-10">
          ...
          <a
            ...
            data-link
            className={cn(
              'group inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.22em] text-ink-soft',
      ...
      <div className="absolute inset-x-0 bottom-8 px-8 md:bottom-10 md:px-16 xl:px-24">
